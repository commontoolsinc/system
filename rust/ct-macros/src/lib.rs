...
/// Requires the `ct_tracing` dependency.
///
/// Implementation defined in `ct_tracing::implementation::ct_tracing_impl`
pub fn ct_tracing(_args: TokenStream, item: TokenStream) -> TokenStream {
    tracing::ct_tracing(item)
}
