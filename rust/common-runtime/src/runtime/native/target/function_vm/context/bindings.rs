...
use super::NativeFunctionVmContext;
...
#[async_trait]
impl common::io::state::Host for NativeFunctionVmContext {
...
#[async_trait]
impl common::data::types::HostReference for NativeFunctionVmContext {
...
impl common::data::types::Host for NativeFunctionVmContext {}

#[async_trait]
impl common::function::reflect::Host for NativeFunctionVmContext {
