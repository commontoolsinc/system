//! The traits herein are intended for use as a compatibility mechanism for
//! async code that may target both `wasm32-unknown-unknown` as well as
//! native targets where the implementer may be shared across threads.
