...
/// A trait for Runtime-specific module drivers.
///
/// A [ModuleDriver] is implemented by a Runtime for each distinctive form of [crate::ModuleDefinition] that it is able to instantiate. The driver produces a prepared [ModuleFactory] for a given [crate::ModuleDefinition], which can in turn be used to instantiate a [crate::Module].
#[async_trait]
