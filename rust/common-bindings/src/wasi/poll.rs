use crate::wasi::{bindings::io::poll, WasiImpl, WasiView};
...
/// use common_bindings::wasi::{WasiView, Subscribe, subscribe, Pollable, async_trait};
...
#[async_trait::async_trait]
impl<T> crate::bindings::wasi::io::poll::HostPollable for WasiImpl<T>
where
    T: WasiView,
{
...
pub mod sync {
    use crate::{
        wasi::bindings::io::poll as async_poll,
        wasi::bindings::sync::io::poll,
        wasi::runtime::in_tokio,
        wasi::{Pollable, WasiImpl, WasiView},
    };
    use anyhow::Result;
    use wasmtime::component::Resource;
    ...
    impl<T> crate::bindings::wasi::sync::io::poll::HostPollable for WasiImpl<T>
    where
        T: WasiView,
    {
