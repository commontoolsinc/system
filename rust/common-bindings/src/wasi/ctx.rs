...
///
/// ```
/// use common_bindings::wasi::{WasiCtxBuilder, WasiCtx};
///
...
impl WasiCtxBuilder {
    ...
    ///
    /// ```
    /// use common_bindings::wasi::WasiCtxBuilder;
    ///
    /// let mut wasi = WasiCtxBuilder::new();
    /// wasi.envs(&[
    ///     ("FOO", "bar"),
...
///
/// ```
/// use common_bindings::wasi::{ResourceTable, WasiCtx, WasiView, WasiCtxBuilder};
///
/// struct MyState {
///     ctx: WasiCtx,
///     table: ResourceTable,
