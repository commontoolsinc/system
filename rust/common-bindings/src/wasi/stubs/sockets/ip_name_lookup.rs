...
use crate::wasi::bindings::sockets::network::{ErrorCode, IpAddress};
...
impl<T> crate::wasi::bindings::sockets::ip_name_lookup::Host for WasiImpl<T>
where
    T: WasiView,
{
...
#[async_trait::async_trait]
impl<T> crate::wasi::bindings::sockets::ip_name_lookup::HostResolveAddressStream for WasiImpl<T>
where
    T: WasiView,
{
