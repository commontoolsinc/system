...
impl<T> crate::bindings::http::outgoing_handler::Host for WasiImpl<T>
where
    T: WasiView,
{
    fn handle(
...
impl<T> crate::bindings::http::types::Host for WasiImpl<T>
where
    T: WasiView,
{
...
impl<T> crate::bindings::http::types::HostFields for WasiImpl<T>
where
    T: WasiView,
{
...
impl<T> crate::bindings::http::types::HostIncomingRequest for WasiImpl<T>
where
    T: WasiView,
{
...
impl<T> crate::bindings::http::types::HostOutgoingRequest for WasiImpl<T>
where
    T: WasiView,
{
    fn new(
...
impl<T> crate::bindings::http::types::HostResponseOutparam for WasiImpl<T>
where
    T: WasiView,
{
...
impl<T> crate::bindings::http::types::HostIncomingResponse for WasiImpl<T>
where
    T: WasiView,
{
...
impl<T> crate::bindings::http::types::HostFutureTrailers for WasiImpl<T>
where
    T: WasiView,
{
...
impl<T> crate::bindings::http::types::HostIncomingBody for WasiImpl<T>
where
    T: WasiView,
{
    fn stream(
...
impl<T> crate::bindings::http::types::HostOutgoingResponse for WasiImpl<T>
where
    T: WasiView,
{
    fn new(
...
impl<T> crate::bindings::http::types::HostFutureIncomingResponse for WasiImpl<T>
where
    T: WasiView,
{
...
impl<T> crate::bindings::http::types::HostOutgoingBody for WasiImpl<T>
where
    T: WasiView,
{
    fn write(
...
impl<T> crate::bindings::http::types::HostRequestOptions for WasiImpl<T>
where
    T: WasiView,
{
