...
impl<T> crate::bindings::sockets::tcp_create_socket::Host for WasiImpl<T>
where
    T: WasiView,
{
...
impl<T> crate::bindings::sockets::tcp::Host for WasiImpl<T> where T: WasiView {}

#[async_trait::async_trait]
impl<T> crate::bindings::sockets::tcp::HostTcpSocket for WasiImpl<T>
where
    T: WasiView,
{
    async fn start_bind(
