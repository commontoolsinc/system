...
impl<T> crate::bindings::random::random::Host for WasiImpl<T>
where
    T: WasiView,
{
...
impl<T> crate::bindings::random::insecure::Host for WasiImpl<T>
where
    T: WasiView,
{
...
impl<T> crate::bindings::random::insecure_seed::Host for WasiImpl<T>
where
    T: WasiView,
{
